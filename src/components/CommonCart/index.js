                            ...
                            <div className="flow-root">
                                {
                                    cartItems && cartItems.length ?
                                        <ul className="-my-8">
                                            ...
                                            {
                                                cartItems.map(item => <li className="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0" key={item.id}>
                                                    ...
                                                    <div className="flex flex-1 flex-col justify-between">
                                                        <div className="sm:col-gap-5 sm:grid-cols-2">
                                                            ...
                                                            <div className="mt-4 flex gap-3 items-end justify-between sm:mt-0 sm:items-start sm:justify-end">
                                                                ...
                                                                <button onClick={() => handleDeleteCartItem(item._id)} type="button" className="font-medium text-yellow-700 sm:order-2">
                                                                    {
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <p className="text-lg text-black font-semibold">
                                        ${
                                            cartItems && cartItems.length ?
                                                cartItems.reduce(
                                                    (total, cartItem) => cartItem.productID.price + total, 0
                                                )
                                                : '0'
                                        }
                                    </p>
