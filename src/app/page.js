...
const Home = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <section className="">
        <div className="grid max-w-screen-xl shadow-lg px-4 py-8 mx-suto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div className="max-w-screen-xl shadow-lg px-4 py-8 mx-auto sm:py-12 sm:px-6 lg:px-8">
        ...
        <div className="max-w-screen-xl shadow-lg px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
