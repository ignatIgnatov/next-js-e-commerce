            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-gray-100 px-4 pt-8 lg:mt-0">
                        ...
                        {addresses && addresses.length ? (
                            addresses.map((item) => (
                                <div
                                    ...
                                    key={item._id}
                                    className={`border p-6 ${item._id === selectedAddress ? "border-red-800" : ""
                                        }`}
                                >
                    ...
                    <button
                        ...
                        className="mt-5 mr-5 inline-block bg-gray-800 text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
                    >
                        Add new address
                    </button>
